...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/TRC2026a.png" class="teaser img-fluid z-depth-1">
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/IF2026.png" class="teaser img-fluid z-depth-1">
    <abbr class="badge">Unpublished</abbr>
  </div>

  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="title"><a>21. Beyond determinacy: Provably non-asymptotic convergent stochastic distributed trilevel optimization</a></div>
    <div class="author">Yang Jiao<sup>#</sup>, <strong>Wenhan Wu</strong>*</div>
    <div class="periodical"><em>Information Fusion, 2026, Submitted.</em></div>
    <div class="links">
    <a href="xxxxxxxxxxxxx" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Article Website</a>
      <a href="assets/files/2026 TRC.pdf" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">PDF</a>
      <strong style="color:#7b5aa6">JCR Q1, IF = 7.9, Citations = 0</strong>
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/TITS2026.png" class="teaser img-fluid z-depth-1">
    <abbr class="badge">Unpublished</abbr>
  </div>
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="periodical"><em>IEEE Transactions on Intelligent Transportation Systems, 2026, Submitted.</em></div>
    <div class="links">
    <a href="xxxxxxxxxxxxx" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Article Website</a>
      <a href="assets/files/2026 TRC.pdf" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">PDF</a>
      <strong style="color:#7b5aa6">JCR Q1, IF = 7.9, Citations = 0</strong>
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/npj2026.png" class="teaser img-fluid z-depth-1">
    <abbr class="badge">Unpublished</abbr>
  </div>

  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="title"><a>19. Sun or shade? Trajectory-level adaptation of pedestrian behavior to urban heat in Tokyo</a></div>
    <div class="author">Kee Moon Jang<sup>#</sup>*, <strong>Wenhan Wu</strong><sup>#</sup>, Marco Seccaroni, Fábio Duarte*, Paolo Santi, Carlo Ratti</div>
    <div class="periodical"><em>npj Urban Sustainability, 2026, Submitted.</em></div>
    <div class="links">
    <a href="xxxxxxxxxxxxx" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Article Website</a>
      <a href="assets/files/2026 NC.pdf" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">PDF</a>
<!--       <strong style="color:#7b5aa6">JCR Q1, IF = 7.9, Citations = 0</strong> -->
    </div>
  </div>
</div>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <a href="https://ieeexplore.ieee.org/document/10758305" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Article Website</a>
      ...
      <strong style="color:#7b5aa6">JCR Q2, IF = 4.6</strong>
    </div>
  </div>
</div>
</li>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <a href="https://www.sciencedirect.com/science/article/pii/S0957417423032633" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Article Website</a>
      ...
      <strong style="color:#7b5aa6">JCR Q1, IF = 9.4</strong>
    </div>
  </div>
</div>
</li>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <a href="https://doi.org/10.1016/j.trc.2023.104154" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Article Website</a>
      ...
      <strong style="color:#7b5aa6">JCR Q1, IF = 8.4</strong>
    </div>
  </div>
</div>
</li>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <a href="https://ieeexplore.ieee.org/abstract/document/10086659" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Article Website</a>
      ...
      <strong style="color:#7b5aa6">JCR Q1, IF = 9.9</strong>
    </div>
  </div>
</div>
</li>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <a href="https://ieeexplore.ieee.org/abstract/document/9614079" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Article Website</a>
      ...
      <strong style="color:#7b5aa6">JCR Q1, IF = 5.4</strong>
    </div>
  </div>
</div>
</li>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <a href="https://ieeexplore.ieee.org/abstract/document/9311833" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Article Website</a>
      ...
      <strong style="color:#7b5aa6">JCR Q1, IF = 11.3</strong>
    </div>
  </div>
</div>
</li>
